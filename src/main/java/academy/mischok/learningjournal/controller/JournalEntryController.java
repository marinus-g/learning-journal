...
public class JournalEntryController {
    ...
    public String journalEntries(@AuthenticationPrincipal UserEntity userEntity, Model model, HttpServletRequest request) {
        List<JournalEntryDto> testEntries = new ArrayList<>();
        testEntries.add(new JournalEntryDto(1L, Instant.now(), 1L, 1L, "Mathematik", "Algebra", "Lorem Ipsum x1", "Entry", List.of("tag1", "tag2")));
        testEntries.add(new JournalEntryDto(2L, Instant.now(), 1L, 1L, "Mathematik", "Algebra", "Lorem Ipsum x2","Lorem ipsum dolor sit amet, consetetur sadipscing elitr, sed diam nonumy eirmod tempor invidunt ut labore et dolore magna aliquyam erat, sed diam voluptua. At vero eos et accusam et justo duo dolores et ea rebum. Stet clita kasd gubergren, no sea takimata sanctus est Lorem ipsum dolor sit amet. Lorem ipsum dolor sit amet, consetetur sadipscing elitr, sed diam nonumy eirmod tempor invidunt ut labore et dolore magna aliquyam erat, sed diam voluptua. At vero eos et accusam et justo duo dolores et ea rebum. Stet clita kasd gubergren, no sea takimata sanctus est Lorem ipsum dolor sit amet. Lorem ipsum dolor sit amet, consetetur sadipscing elitr, sed diam nonumy eirmod tempor invidunt ut labore et dolore magna aliquyam erat, sed diam voluptua. At vero eos et accusam et justo duo dolores et ea rebum. Stet clita kasd gubergren, no sea takimata sanctus est Lorem ipsum dolor sit amet.   \n" +
                "\n" +
